...
lazy_static::lazy_static! {
    static ref EMAIL_HOST_PASSWORD: String = std::env::var("EMAIL_HOST_PASSWORD").unwrap_or("".to_string());
}
...
impl Email {
    ...
    pub fn send(self) -> Result<String, ApiError> {
        ...
        let mut body: HashMap<String, String> = response
            .json()
            .map_err(|e| ApiError::new(500, format!("Failed to read sendgrid response: {}", e)))?;
